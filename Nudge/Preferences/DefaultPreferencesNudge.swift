...
let acceptableCameraUsage = optionalFeaturesProfile?["acceptableCameraUsage"] as? Bool ?? optionalFeaturesJSON?.acceptableCameraUsage ?? true
...
let cameraReferralTime = userExperienceProfile?["cameraReferralTime"] as? Int ?? userExperienceJSON?.cameraReferralTime ?? 0
